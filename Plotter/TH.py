...
matplotlib.rcParams['axes.color_cycle'] = ['r','b','b','k']
...
sql = "select time,temp,humi from Log"
cursor.execute(sql)
...
plt.title("<Unifesp_lab402_Forgers> Temperature (Red), Humidity (Blue)")
plt.hold(True)
...
FileName = '/home/pi/WeatherStation/Python/Graphics/TH.jpg'
plt.savefig(FileName)

print 'Copy to Web Server...',
Destination = '/var/www/images/'
os.system("sudo cp //home/pi/WeatherStation/Python/Graphics/TH.jpg {}".format(Destination))
