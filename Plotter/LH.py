...
matplotlib.rcParams['axes.color_cycle'] = ['y','b','b','k']
...
sql = "select time,lux,humi from Log"
cursor.execute(sql)
...
plt.axis(ymax=16000,ymin=100)
plt.xlabel(time.asctime())
plt.title("<Unifesp_lab402_Forgers> Iluminance")
plt.hold(True)
...
FileName = '/home/pi/WeatherStation/Python/Graphics/L.jpg'
plt.savefig(FileName)

print 'Copy to Web Server...',
Destination = '/var/www/images/'
os.system("sudo cp //home/pi/WeatherStation/Python/Graphics/L.jpg {}".format(Destination))
